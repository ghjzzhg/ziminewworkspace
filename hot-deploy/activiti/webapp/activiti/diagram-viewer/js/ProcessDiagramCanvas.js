...
// TODO: generate polylineId or do something!!
		...
		polyClone.click(function(){
			...
			$.ajax({
				url: '/workflow/control/CreateLineActTaskExtForm',
				type: 'POST',
				dataType: 'html',
				data:{sourceId: contextObject.sourceActivityId , targetId: contextObject.destinationActivityId, processDefinitionId:processDefinitionId},
				cache: false,
				async: true
			}).done(function(data) {
				ProcessDiagramGenerator.setFlowInfo(data);
				pb1.set('value', 100);
