<script type="text/javascript" xmlns="http://www.w3.org/1999/html">
    ...
    <#list occupyTime as timeList>
        changeDivBackgroundColor('${timeList.orderId}','vehicle_${timeList.vehicleId}_', '${timeList.startDate}', '${timeList.endDate}');
    </#list>
    <#list occupyTimeForThrough as timeListForThrough>
        changeDivBackgroundColorForThrough('${timeListForThrough.orderId}','vehicle_${timeListForThrough.vehicleId}_', '${timeListForThrough.startDate}', '${timeListForThrough.endDate}');
    </#list>
    <#list occupyTimeForArrange as timeListForArrange>
        changeDivBackgroundColorForArrange('${timeListForArrange.orderId}','vehicle_${timeListForArrange.vehicleId}_', '${timeListForArrange.startDate}', '${timeListForArrange.endDate}');
    </#list>
    })
</script>
...
<form name="vehicleList">
    ...
    <#list vehicleShow as list>
                        ...
                        <td>
                            <div>
                                <#list 0..48 as divList>
                                    <div id="vehicle_${list.vehicleId}_${divList}"
                    ...
                    <tr>
                        <td>
                            <div style="width:800px;">
                                <#list 0..48 as divList>
                                    <div id="vehicle_time_${list.vehicleId}_${divList}"
        ...
        <#list 16..23 as changeDivList>
            <script>
                changeDivBackgroundColorForTime('vehicle_time_${list.vehicleId}_${changeDivList}');
            </script>
        </#list>
