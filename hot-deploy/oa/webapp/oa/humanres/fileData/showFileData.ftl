                ...
                <table style="width:100%" class="basic-table" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                        ...
                        <td colspan="10">
                            ...
                            <script>
                                $("#remarks1").append("<label>"+ unescapeHtmlText('${remarks?default('')}') +"</label>");
                            </script>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="10">
                            <div id="documentContent1" >
                            </div>
                            <script>
                                $("#documentContent1").append("<label>"+ unescapeHtmlText('${documentContent?default('')}') +"</label>");
                            </script>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">
                            <label for="auditContent">审核内容：</label>
                        </td>
                        <td  colspan="7">
                            <div id="auditContent" >
                            </div>
                            <script>
                                $("#auditContent").append("<label>"+ unescapeHtmlText('${auditContent?default('')}') +"</label>");
                            </script>
                        </td>
                    </tr>
                </table>
