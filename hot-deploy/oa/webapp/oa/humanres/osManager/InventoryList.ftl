...
<#if data.list?has_content>
    ...
    <#assign commonUrl = "searchInventoryList"/>
    ...
    <#if data.list?has_content>
        ...
        <#list data.list as line>
            <tr id="ss">
                ...
                <td>
                    <a name="editLink" href="#" onclick="$.InventoryManagement.inputInventory(${line.osManagementId?default('')})" title="入库" class="smallSubmit">
                        <label>入库</label>
                    </a>
                </td>
                <td>
                    <a name="deleteLink" href="#" onclick="$.InventoryManagement.outInventory(${line.osManagementId?default('')})" title="出库" class="smallSubmit">
                        <label>出库</label>
                    </a>
                </td>
            </tr>
...
<#if data.list?has_content>
    <@nextPrevAjax targetId="InventoryListResult" commonUrl=commonUrl param=param paginateStyle="nav-pager" paginateFirstStyle="nav-first"
