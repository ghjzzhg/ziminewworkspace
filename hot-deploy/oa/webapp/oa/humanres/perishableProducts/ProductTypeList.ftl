...
<#if data.list?has_content>
    ...
    <#assign commonUrl = "ProductTypeList"/>
...
<table cellspacing="0" class="basic-table hover-bar">
    ...
    <#if data.list?has_content>
        ...
        <tr<#if alt_row> class="alternate-row"</#if> id="ss">
                ...
                <td>
                    <a href="#" onclick="$.inventory.editProductTypeInfo('${line.productTypeId?default('')}')" title="修改" class="icon-edit"></a>
                </td>
                <td>
                    <a href="#" onclick="$.inventory.deleteProductTypeInfo('${line.productTypeId?default('')}')" title="删除" class="icon-trash"></a>
                </td>
            </tr>
...
<#if data.list?has_content>
    <@nextPrevAjax targetId="ProductTypeList" commonUrl=commonUrl param=param paginateStyle="nav-pager" paginateFirstStyle="nav-first"
