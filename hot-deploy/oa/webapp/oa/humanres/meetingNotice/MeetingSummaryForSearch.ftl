...
<form method="post" action="" id="MeetingSummarySearchForm" class="basic-form" onsubmit="javascript:submitFormDisableSubmits(this)" name="MeetingSummarySearchForm">
    <table cellspacing="0" class="basic-table">
        ...
        <tr>
            ...
            <td>
                <a class="smallSubmit" href="#nowhere" onclick="javascript:$.meetingNotice.searchMeetingSummary();" title="操作">查询</a>
            </td>
        </tr>
        </tbody>
    </table>
