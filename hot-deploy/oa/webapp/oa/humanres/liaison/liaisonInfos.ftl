...
<div id="LiaisonInfo">
    ...
    <#if (liaisonMap.reviewTheStatus != 'LIAISON_STATUS_ONE')>
        <div class="screenlet-title-bar">
            <ul>
                <li class="h3">签收信息</li>
            </ul>
        ...
        <div id="SignForTableList_div">
            <@SignForTableList workSheetSignForInformationList=workSheetSignForInformationList liaisonMap=liaisonMap></@SignForTableList>
        </div>
    </#if>

    <#if liaisonMap.ifResponse =='yes' && !((liaisonMap.reviewTheStatus == 'LIAISON_STATUS_ONE')||(liaisonMap.reviewTheStatus == 'LIAISON_STATUS_TWO'))>
        <div class="screenlet-title-bar">
            <ul>
                <li class="h3">回复信息</li>
            </ul>
        ...
        <div id="ReplyInformationList_div">
            <@ReplyInformationList value='' contactListId=liaisonMap.contactListId></@ReplyInformationList>
        </div>
    </#if>

    <#if (liaisonMap.ifResponse =='yes') && (liaisonMap.reviewTheStatus == 'LIAISON_STATUS_THREE') && (liaisonMap.mainPerson?contains(userLogin.partyId))>
        <div class="screenlet-title-bar">
            <ul>
                <li class="h3">信息回复</li>
            </ul>
        ...
        <@informationReply liaisonMap=liaisonMap mainPerson=liaisonMap.mainPersonNameString copyPerson=liaisonMap.copyPersonNameString></@informationReply>
    </#if>
    </form>
