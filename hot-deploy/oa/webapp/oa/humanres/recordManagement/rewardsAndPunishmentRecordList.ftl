...
<#if data.rewordsPunishmentList?has_content>
    ...
    <#assign commonUrl = "RewardsAndPunishmentRecordList"/>
...
<table cellspacing="0" class="basic-table hover-bar">
    ...
    <#if data.rewordsPunishmentList?has_content>
        ...
        <tr<#if alt_row> class="alternate-row"</#if> id="ss">
            ...
            <td>
                <a href="#" onclick="javascript:$.recordManagement.editReword('${line.rewordId}','${line.partyId}','RewardsAndPunishmentRecordList')" title="修改" class="icon-edit"/>
            </td>
            <td>
                <a href="#" onclick="javascript:$.recordManagement.removeReword('${line.rewordId}','${line.partyId}','RewardsAndPunishmentRecordList')" title="删除" class="icon-trash"/>
            </td>
        </tr>
...
<#if data.rewordsPunishmentList?has_content>
    <@nextPrevAjax targetId="staffInformation_col" commonUrl=commonUrl param=param paginateStyle="nav-pager" paginateFirstStyle="nav-first"
