...
<form method="post" action="" id="CreateEmployee" class="basic-form" onsubmit="javascript:submitFormDisableSubmits(this)" name="CreateEmployee">
    ...
    <table cellspacing="0" class="basic-table">
        ...
        <tr>
            ...
            <td class="label">
                <label for="CreateEmployee_familyAddress" id="CreateEmployee_familyAddress_title">家庭住址：</label>  </td>
            <td colspan="2" class="jqv">
        ...
        <tr>
            ...
            <td colspan="4">
                <a class="smallSubmit" href="#nowhere" onclick="javascript:$.recordManagement.saveEmployees()" title="操作">保存</a>
            </td>
        </tr>
        </tbody>
    </table>
