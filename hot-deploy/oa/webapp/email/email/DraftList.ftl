...
<form method="post" action="" id="Draft" class="basic-form" name="Draft">
    <table cellspacing="0" class="basic-table hover-bar" id="inboxTable">
        <tbody>
        <tr class="header-row-2">
            <td>
                <input type="checkbox" name="selectAll" onclick="javascript:toggleAll(this, 'Draft');" value="Y">
            </td>
            <td>
                <label>状态</label>
            </td>
    ...
    <#if data.list?has_content>
        ...
        <#list data.list as line>
            <tr id="ss">
                ...
                <td>
                    <a href="#nowhere" onclick="javascript:$.email.viewEmail(${line.communicationEventId?default('')},'Draft')" title="发件人">
                        <label>${line.contactMechIdFrom?default("")}</label>
                    </a>
                </td>
                 <td>
                    <a href="#nowhere" onclick="javascript:$.email.viewEmail(${line.communicationEventId?default('')},'Draft')" title="主题">
