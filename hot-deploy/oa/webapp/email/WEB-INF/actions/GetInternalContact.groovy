...
if(parentId){
    switch (parentId){
        case '1': contacts = [
                [id: "11", name: '董事长', pId:"1", address: 'chairman@rextec.com.cn'],
    ...
    contacts = [[id: '1', name: '董事会', isParent: true],
                    [id: '2', name: '行政部门', isParent: true],
                    [id: '3', name: '研发部门', isParent: true],
                    [id: '4', name: '财务部门', isParent: true]
    ];
}
