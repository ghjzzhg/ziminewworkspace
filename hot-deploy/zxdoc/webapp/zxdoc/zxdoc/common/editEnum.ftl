        ...
        <#if enums?has_content>
                ...
                <tr>
                    <td>
                        ...
                        <input type="text" name="description" class="form-control" value="${enum.description}"
                               style="display: none"/>
                        <input type="hidden" name="enumId" value="${enum.enumId}"/>
                        <input type="hidden" name="enumTypeId" value="${enum.enumTypeId}"/>
                        <input type="hidden" name="seq" value="${enum.sequenceId?default(0)}"/>
                    </td>
                    <td style="white-space: nowrap">
                        ...
                        <#if enum.enumCode??>
                            <#if enum.enumCode=="CASE_PERSON_ROLE_MANAGER" || enum.enumCode=="CASE_PERSON_ROLE_STAFF">
                        <#else>
            ...
            <tr>
                <td>
                    ...
                    <input type="hidden" name="enumTypeId" value="${enumType.enumTypeId}"/>
                    <input type="hidden" name="seq"/>
                    <input type="text" class="form-control" name="description"/>
                    <input type="hidden" name="enumCode"/>
                </td>
                <td style="white-space: nowrap">
                    <a class="btn btn-md green btn-outline" href="#nowhere" onclick="saveRoleType(this, true)" title="保存">
                        <i
                                class="fa fa-save"></i> </a>
