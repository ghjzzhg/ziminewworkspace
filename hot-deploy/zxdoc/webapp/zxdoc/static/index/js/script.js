...
$(document).ready(function() {
    $("section.lazy, img.lazy, div.lazy,footer.lazy").lazyload();
    scroll_top ();
    init_classic_menu();
    // init_accordion();
    // init_toggle();
    ...
    // close_shop_item();
    footer_height();
    $(".owl-carousel").removeClass('hide').owlCarousel({
        autoPlay: true,
        itemsCustom:[
            [479, 3],
            [738, 5],
    ...
    $(".owl-carousel5").removeClass('hide').owlCarousel({
        autoPlay: true,
        itemsCustom:[
            [479, 2],
            [738, 3],
...
function filter_init(){
    var fselector = ".POLICY_CATEGORY_YWGZ";
    var filter_mode;
...
function init_rev_slider () {
    // $(".tp-banner-container").css("background", "none");
