...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    var _ReadOnly,_SWFFile,_PDFFile,_IMGFiles,_JSONFile  = "",_jsDirectory="",_cssDirectory="",_localeDirectory="";_WMode = (config.WMode!=null||config.wmmode!=null?config.wmmode||config.WMode:"window");
    ...
    _ReadOnly  			= (config.ReadOnly!=null?config.ReadOnly:false);
    ...
    window[instance] = flashembed(id, {
        src						    : _jsDirectory+"FlexPaperViewer" + (_ReadOnly?"ReadOnly" : "") +".swf",
        version					    : [10, 0],
