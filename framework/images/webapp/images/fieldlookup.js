...
var Lookup = function(options) {
    ...
    options = {
        ...
        position : options.position || {my: 'top', at: 'center top+15%', of: window},
    ...
    function _positioning() {
        ...
        if (options.position == "topleft") {
            ...
            positioning = {my: 'top', at: 'center top+15%', of: window};
        }
    ...
    function _dialogOpen(event, ui) {
        ...
        jQuery.ajax({
            ...
            data : queryArgs + "&lookupId=" + _lookupId,
...
var ButtonModifier = function(lookupDiv) {
    ...
    function _modifyPagination() {
        // modify nav-pager
        var navPagers = jQuery("#" + lookupDiv + " .nav-pager a" + ", #" + lookupDiv + " .nav-pager li.nav-first" + ", #" + lookupDiv + " .nav-pager li.nav-last" + ", #" + lookupDiv + " .nav-pager li.nav-next" + ", #" + lookupDiv + " .nav-pager li.nav-previous");
        ...
        var navPagersSelect = jQuery("#" + lookupDiv + " .nav-pager select" + ",#" + lookupDiv + " .nav-pager input[type=text]");
...
function set_value(value) {
    ...
    var target = obj_caller.target;
    write_value(value, target);
    if(top.window.lookupUserDepartment){
        lookupUserDepartment(value);
    }
    if(top.window.showLookupInfo){
        showLookupInfo(value);
    }
    closeLookup();
}
// function passing selected value to calling window
