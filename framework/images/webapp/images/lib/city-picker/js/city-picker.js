...
(function (factory) {
    ...
    function CityPicker(element, options) {
        ...
        if(this.options.valueField){
            this.$elementCode = $(this.options.valueField);
        }else{
            this.$elementCode = this.$element.siblings(":hidden");
        }
    ...
    CityPicker.prototype = {
        ...
        getValCode: function () {
            var item = this.$dropdown.find('.city-select.district').data("item") || this.$dropdown.find('.city-select.city').data("item") || this.$dropdown.find('.city-select.province').data("item");
            if(item){
                return item.code;
            }
            return '';
        ...
        feedValCode: function () {
            if(!this.$elementCode.length){
                alert("请在初始化参数中指定valueField或添加hidden字段存储code值");
                return;
            }
            this.$elementCode.val(this.getValCode());
        },
