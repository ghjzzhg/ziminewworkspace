...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/images/lib/pdfjs/web/images/';
  PDFJS.workerSrc = '/images/lib/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '/images/lib/pdfjs/web/cmaps/';
...
function webViewerInitialized() {
  var fileUrl = document.getElementById("pdfFileUrl").value;
  var file = fileUrl ? fileUrl : DEFAULT_URL;
