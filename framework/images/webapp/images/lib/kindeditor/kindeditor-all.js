...
KindEditor.lang({
    ...
    fileType : '请选择图片文件,支持格式*.jpg;*.jpeg;*.gif;*.png;*.bmp',
...
KindEditor.plugin('filemanager', function(K) {
	var self = this, name = 'filemanager',
		...
		fileManagerJson = K.undef(self.fileManagerJson,'fileList4kindEditor'),
...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		uploadJson = K.undef(self.uploadJson, 'uploadFileList4kindEditor');
	self.plugin.flash = {
		edit : function() {
			var html = [
				...
				var uploadbutton = K.uploadbutton({
					...
					afterUpload : function(data) {
						...
						if (data.error === 0) {
							...
							showInfo(self.lang('uploadSuccess'));
						} else {
							alert(data.message);
						}
					},
...
KindEditor.plugin('insertfile', function(K) {
	...
	self.clickToolbar(name, function() {
		self.plugin.fileDialog({
			clickFn : function(url, title) {
				var html = '<a class="ke-insertfile" href="' + url + '" data-ke-src="' + url + '" target="_blank"><img name="leftImg" src="' + imgPath + 'fujian.gif" width="23" height="25" alt="" />' + fileName + '</a>';
				self.insertHtml(html).hideDialog().focus();
			}
		});
	});
