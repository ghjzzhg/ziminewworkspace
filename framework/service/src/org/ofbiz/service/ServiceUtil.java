...
public class ServiceUtil {
    ...
    public static Map<String, Object> reloadMailConainter(DispatchContext dctx, Map<String, Object> context) {
        Container mailContainer = ContainerLoader.getContainerByName("javamail-container");
        if(mailContainer != null){
            try {
                mailContainer.stop();
                mailContainer.start();
            } catch (ContainerException e) {
                Debug.logError(e, "fail to restart mail container", module);
            }
        }
        return ServiceUtil.returnSuccess();
    }
