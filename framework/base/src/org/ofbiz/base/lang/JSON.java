...
public final class JSON {
    ...
    static {
        SimpleModule simpleModule = new SimpleModule("TimestampModule",
                new Version(1,0,0,null));
        simpleModule.addSerializer(java.sql.Timestamp.class, new TimeStampJSONSerializer());
        mapper.registerModule(simpleModule);
        simpleModule = new SimpleModule("DateModule",
                new Version(1,0,0,null));
        simpleModule.addSerializer(java.sql.Date.class, new DateJSONSerializer());
        mapper.registerModule(simpleModule);
    }
    /**
