...
public class ContainerLoader implements StartupLoader {
    ...
    private static Map<String, Container> loadedContainersMap = new HashMap<String, Container>();
    ...
    public synchronized void load(Config config, String args[]) throws StartupException {
        ...
        for (ContainerConfig.Container containerCfg : containers) {
            ...
            if (matchingLoaderFound) {
                ...
                loadedContainersMap.put(containerCfg.name, tmpContainer);
    ...
    public static Container getContainerByName(String name){
        return loadedContainersMap.get(name);
    }
}
