                    ...
                    if (UtilValidate.isNotEmpty(prefix)) {
                        if (fieldName.startsWith(prefix)) {
                            ...
                            if (!(value instanceof String)) {
                                ...
                                paramMap.put("fileBytes", value);
                                String nameKey = "_" + fieldName + "_fileName";
                                Object nameVal = additionalFields.get("_" + fieldName + "_fileName");
                                if (nameVal != null) {
                                    paramMap.put("fileName", nameVal);
                                }

                                String typeKey = "_" + fieldName + "_contentType";
                                Object typeVal = additionalFields.get("_" + fieldName + "_contentType");
                                if (typeVal != null) {
                                    paramMap.put("contentType", typeVal);
                                }

                                String sizeKey = "_" + fieldName + "_size";
                                Object sizeVal = additionalFields.get("_" + fieldName + "_size");
                                if (sizeVal != null) {
                                    paramMap.put("size", sizeVal);
                                }
