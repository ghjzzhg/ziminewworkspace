...
public class StringUtil {
    ...
    public static int xmlDecodedLength(String str){
        if(UtilValidate.isEmpty(str)){
            return 0;
        }
        return UtilCodec.getDecoder("html").decode(str).length();
    }

    public static String xmlDecodedSubstring(String str, int start, int end){
        if(UtilValidate.isEmpty(str)){
            return "";
        }
        return UtilCodec.getDecoder("html").decode(str).substring(start, end);
    }
}
