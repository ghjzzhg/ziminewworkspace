...
public class LoginServices {
            ...
            while (repeat) {
                ...
                if (userLogin != null) {
                    ...
                    if (UtilValidate.isEmpty(userLogin.getString("enabled")) || "Y".equals(userLogin.getString("enabled")) ||
                        ...
                        String enabled = (String) userLogin.get("enabled");
                        if (disabledDateTime != null && enabled.equals("N")) {
                        ...
                        if (loginDisableMinutes > 0 && reEnableTime != null && enabled.equals("N")) {
    ...
    public static Map<String, Object> isPermission(DispatchContext ctx, Map<String, ?> context) {
        Delegator delegator = ctx.getDelegator();
        Security security = ctx.getSecurity();
        GenericValue loggedInUserLogin = (GenericValue) context.get("userLogin");
        Locale locale = (Locale) context.get("locale");
