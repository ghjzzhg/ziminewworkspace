package org.ofbiz.common.pinyin;
...
public class PinyinHelper {
	...
	public static String getShortPinyin(HttpServletRequest request, HttpServletResponse response){
		String hanziContent = request.getParameter("hanziContent");
		String result = "";
		if(StringUtils.isNotBlank(hanziContent)){
			result = getShortPinyin(hanziContent.trim());
		}
		request.setAttribute("pinyin", result);
		return "success";
	}
