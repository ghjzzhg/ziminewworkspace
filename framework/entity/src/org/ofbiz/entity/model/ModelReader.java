...
public class ModelReader implements Serializable {
    ...
    private ModelEntity buildEntity(ResourceHandler entityResourceHandler, Element curEntityElement, int i, ModelInfo def) throws GenericEntityException {
        ...
        boolean isViewEntity = "view-entity".equals(curEntityElement.getNodeName());
        boolean isUnionViewEntity = "union-view-entity".equals(curEntityElement.getNodeName());
        ...
        } else if (isViewEntity) {
            modelEntity = createModelViewEntity(curEntityElement, null, def);
        } else if (isUnionViewEntity) {
            modelEntity = createModelUnionViewEntity(curEntityElement, null, def);
        }
        ...
        if (modelEntity != null) {
            ...
            if (isEntity) {
                ...
                if (Debug.verboseOn()) Debug.logVerbose("-- [UnionViewEntity]: #" + i + ": " + entityName, module);
            }
        } else {
                    ...
                    for (ResourceHandler entityResourceHandler: entityResourceHandlers) {
                        ...
                        if (curChild != null) {
                            ...
                            do {
                                ...
                                boolean isUnionViewEntity = "union-view-entity".equals(curChild.getNodeName());

                                if ((isEntity || isViewEntity || isUnionViewEntity) && curChild.getNodeType() == Node.ELEMENT_NODE) {    
                                    i++;
                                    ...
                                    if (isViewEntity || isUnionViewEntity) {
...
TEMP_VIEW_LOOP:
    ...
    ModelEntity createModelUnionViewEntity(Element entityElement, UtilTimer utilTimer, ModelInfo def) {
    if (entityElement == null) return null;
        this.numViewEntities++;
        ModelUnionViewEntity entity = new ModelUnionViewEntity(this, entityElement, utilTimer, def);
        return entity;
    }
