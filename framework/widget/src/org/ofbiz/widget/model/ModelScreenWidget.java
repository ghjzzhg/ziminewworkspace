...
import org.ofbiz.widget.renderer.*;
...
public abstract class ModelScreenWidget extends ModelWidget {
    ...
    public static final class Screenlet extends ModelScreenWidget {
        ...
        public Screenlet(ModelScreen modelScreen, Element screenletElement) {
            ...
            this.titleStyleExdr = FlexibleStringExpander.getInstance(screenletElement.getAttribute("titleStyle"));
        ...
        public String getTitleStyle(Map<String, Object> context) {
            String titleStyle = this.titleStyleExdr.expandString(context);
            UtilCodec.SimpleEncoder simpleEncoder = (UtilCodec.SimpleEncoder) context.get("simpleEncoder");
            if (simpleEncoder != null) {
                titleStyle = simpleEncoder.encode(titleStyle);
            }
            return titleStyle;
        }
        ...
        public FlexibleStringExpander getTitleStyleExdr() {
            return titleStyleExdr;
        }
