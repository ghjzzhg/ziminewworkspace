...
public class ModelMenu extends ModelWidget {
    ...
    private final FlexibleStringExpander defaultMenuItemName;
    ...
    public ModelMenu(Element menuElement, String menuLocation) {
        ...
        FlexibleStringExpander defaultMenuItemName = FlexibleStringExpander.getInstance("");
        ...
        if (!menuElement.getAttribute("default-menu-item-name").isEmpty())
            defaultMenuItemName = FlexibleStringExpander.getInstance(menuElement.getAttribute("default-menu-item-name"));
    ...
    public FlexibleStringExpander getDefaultMenuItemName() {
    ...
    public String getSelectedMenuItemContextFieldName(Map<String, Object> context) {
        ...
        if (UtilValidate.isEmpty(menuItemName)) {
            return this.defaultMenuItemName.expandString(context);
        }
        return menuItemName;
    }
