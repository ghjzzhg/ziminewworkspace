...
public abstract class ModelForm extends ModelWidget {
    ...
    public String getPaginateFirstLabel(Map<String, Object> context) {
        ...
        if (UtilValidate.isEmpty(field)) {
            field = UtilProperties.getMessage("CommonUiLabels", "PaginationFirst", locale);
        }
        return field;
    }
    ...
    public String getPaginateLastLabel(Map<String, Object> context) {
        ...
        if (UtilValidate.isEmpty(field)) {
            field = UtilProperties.getMessage("CommonUiLabels", "PaginationLast", locale);
        }
        return field;
    }
    ...
    public String getPaginateNextLabel(Map<String, Object> context) {
        ...
        if (field.isEmpty()) {
            Locale locale = (Locale) context.get("locale");
            return UtilProperties.getMessage("CommonUiLabels", "PaginationNext", locale);
        }
        return field;
    }
    ...
    public String getPaginatePreviousLabel(Map<String, Object> context) {
        ...
        if (field.isEmpty()) {
            Locale locale = (Locale) context.get("locale");
            field = UtilProperties.getMessage("CommonUiLabels", "PaginationPrevious", locale);
        }
        return field;
    }
