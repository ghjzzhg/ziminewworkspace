...
public class XmlWidgetFieldVisitor extends XmlAbstractWidgetVisitor implements ModelFieldVisitor {
    ...
    public void visit(DropDownField dropDownField) throws Exception {
        ...
        visitAttribute("importability", dropDownField.getImportability());
        visitAttribute("aloneFunction", dropDownField.getAloneFunction());
        visitAttribute("url", dropDownField.getUrl());
        visitAttribute("enumTypeId", dropDownField.getEnumTypeId());
        visitAttribute("callback", dropDownField.getCallback());
