...
<!-- ${boundaryComment} -->
  ...
  <ul id="${id?default('')}_mainMenu" class="nav navbar-nav">
</#macro>
...
<#macro renderMenuItemBegin style toolTip linkStr containsNestedMenus nestedMenuSelected=false menuLevel=0>
        <li class="<#if style?has_content>${style}</#if><#if containsNestedMenus> <#if menuLevel &gt;=1>dropdown-submenu<#else>menu-dropdown</#if></#if> <#if nestedMenuSelected> active</#if>"><#if linkStr?has_content>${linkStr}</#if><#if containsNestedMenus><ul class="dropdown-menu<#if menuLevel = 1> pull-left</#if>"></#if><#rt/>
</#macro>
