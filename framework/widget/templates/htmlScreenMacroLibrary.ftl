...
<#if showMore>
<div class="screenlet-title-bar"><ul><#if title?has_content><li class="h3<#if titleStyle?has_content> ${titleStyle}</#if>"><#if !titleStyle?has_content><i class="glyphicon glyphicon-forward"></i></#if><span>${title}</span></li></#if>
<#if collapsible>
<li class="<#rt/>
<#if collapsed>
