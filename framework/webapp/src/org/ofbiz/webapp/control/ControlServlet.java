...
public class ControlServlet extends HttpServlet {
    ...
    private String getRootCouseMessage(Throwable e){
        Throwable root = e.getCause();
        if(root == null){
            return e.getMessage();
        }else{
            return getRootCouseMessage(root);
        }
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ((ajax != null && Boolean.parseBoolean(ajax)) || (request.getHeader("accept") != null && request.getHeader("accept").contains("application/json")) || (request
        ...
        try {
            ...
            if (throwable instanceof IOException) {
                ...
                request.setAttribute("_ERROR_MESSAGE_", UtilCodec.getEncoder("html").encode(getRootCouseMessage(throwable)));
            ...
            request.setAttribute("_ERROR_MESSAGE_", UtilCodec.getEncoder("html").encode(getRootCouseMessage(e)));
            errorPage = requestHandler.getDefaultErrorPage(request);
        }
