	...
	CKFinder.dialog.add( 'fileEditor', function( api )
	{
		...
		return {
			...
			onShow : function()
			{
				...
				var url = api.connector.composeUrlWithId( 'DownloadFile', { FileName : file.name, format : 'text', t : new Date().getTime() },
						file.folder.type, file.folder ,file.folder.folderId,file.fileId);
