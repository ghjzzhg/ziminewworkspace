...
CKFinder.lang['zh-cn'] =
{
	...
	FilesDelete	: '确定删除文件 %1 吗?', // MISSING
	FilesLoading	: '加载中...',
	FilesEmpty		: '空文件夹',
	DestinationFile	: '目标文件', // MISSING
	SkippedFiles	: '忽略的文件:', // MISSING
	...
	BasketRemoveConfirmMultiple	: '确定删除 %1 ?', // MISSING
	BasketEmpty			: '临时文件夹为空, 可拖放文件至其中。',
	BasketCopyFilesHere	: '从临时文件夹复制至此',
	BasketMoveFilesHere	: '从临时文件夹移动至此',

	// Global messages
	OperationCompletedSuccess	: '操作完成成功.', // MISSING
	OperationCompletedErrors		: '操作完成但有错误.', // MISSING
	FileError				: '%s: %e', // MISSING

	// Move and Copy files
	MovedFilesNumber		: '移动文件数: %s.', // MISSING
	CopiedFilesNumber	: '拷贝文件数: %s.', // MISSING
	MoveFailedList		: '文件无法移动:<br />%s', // MISSING
	CopyFailedList		: '文件无法拷贝:<br />%s', // MISSING
	...
	ErrorMsg :
	{
		...
		FolderExists	: '文件夹 %s 已存在。', // MISSING
	...
	Zip :
	{
		extractHereLabel	: '解压到当前目录', // MISSING
		extractToLabel		: '解压到...', // MISSING
		downloadZipLabel	: 'zip下载', // MISSING
		compressZipLabel	: '压缩成zip', // MISSING
		removeAndExtract	: '解压并删除原文件', // MISSING
		extractAndOverwrite	: '解压并覆盖', // MISSING
		extractSuccess		: '解压成功。' // MISSING
	},
