 ...
 */
public class DownloadZxdocFileCommand extends Command {
	...
	public void execute(final OutputStream out) throws ConnectorException {
		...
		if("他人分享".equals(this.type) || "本人分享".equals(this.type)){
			...
			newPath = configuration.getTypes().get(this.type).getPath() + currentFolder + fileName;
		}
		this.file = new File(disc + newPath);
	...
	public void initParams(final HttpServletRequest request,
		...
		this.fileId = getParameter(request, "fileId");
		try {
