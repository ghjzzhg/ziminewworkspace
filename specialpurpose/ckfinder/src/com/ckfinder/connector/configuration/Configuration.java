...
public class Configuration implements IConfiguration {
	 ...
	 */
	public final IConfiguration cloneConfiguration(String person) {
		Configuration configuration = createConfigurationInstance();
		copyConfFields(configuration,person);
	 ...
	 */
	protected void copyConfFields(final Configuration configuration,String person) {
		...
		copyTypes(configuration.types,person);
	 ...
	 */
	private void copyTypes(final Map<String, ResourceType> newTypes,String person) {
		for (String name : this.typesOrder) {
			newTypes.put(name, new ResourceType(this.types.get(name),person));
		}
	}
}
