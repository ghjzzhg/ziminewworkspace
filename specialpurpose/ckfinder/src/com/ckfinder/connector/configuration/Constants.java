...
public class Constants {
	...
	public static final String PRIVATE_FOLDER_ENTRY = "1";
	public static final String SHARE_FOLDER_ENTRY = "2";
	public static final String CASE_FOLDER_ENTRY = "3";
	public static final String PRIVATE_FOLDER_TYPE = PRIVATE_FOLDER_ENTRY;
	public static final String SHARE_FOLDER_TYPE = SHARE_FOLDER_ENTRY;
	/**
	...
	public static class Errors {
		...
		public static final int CKFINDER_CONNECTOR_ERROR_NONE = 0;//正常
		...
		public static final int CKFINDER_CONNECTOR_ERROR_DELETE_FOLDER = 502;
		public static final int CKFINDER_CONNECTOR_ERROR_DELETE_FILE = 503;

		public static final int CKFINDER_CREATE_FOLDER_ERROR = 601; //目录无法创建
		public static final int CKFINDER_FILE_SIZE = 602; //文件过大
		public static final int CKFINDER_FOLDER_REPEAT = 603; //文件夹重复
		public static final int CKFINDER_FILE_REPEAT = 604; //文件夹重复
	}
}