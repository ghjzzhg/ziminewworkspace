...
<#escape x as x?html>
  ...
  <#if (errorMessage?has_content || errorMessageList?has_content)>
    <div id="content-messages" style="display: none" class="content-messages errorMessage" onclick="document.getElementById('content-messages').parentNode.removeChild(this)">
  ...
  <#if (eventMessage?has_content || eventMessageList?has_content)>
    <div id="content-messages" style="display: none" class="content-messages eventMessage" onclick="document.getElementById('content-messages').parentNode.removeChild(this)">
  ...
  <script type="text/javascript">
      $(function(){
          ...
          if(msg.length){
              layer.alert(msg.html(), {icon: 5, closeBtn:1,offset:'rb'});
          }
          msg = $(".eventMessage");
          if(msg.length){
              layer.msg(msg.html(), {icon: 1, closeBtn:1,offset:'rb'});
          }
      })
  </script>
</#escape>
